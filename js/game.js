...
import { playerLost, isShipDestroied,welcomeUserMessage,displayData,countDownTimer } from "./function.js";
...
window.addEventListener("DOMContentLoaded", function () {
    ...
    let id = setInterval(() => {
      ...
      let shipExploded = isShipDestroied([...document.querySelectorAll(".enemies")],spaceShip.gun);
